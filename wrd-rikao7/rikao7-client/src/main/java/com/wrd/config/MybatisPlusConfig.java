...
public class MybatisPlusConfig {
    ...
    public static void main(String[] args) {
     ...
     String moduleName = "wrd-rikao7";
        ...
        gc.setOutputDir(projectPath + "/" +moduleName+"/rikao7-client/src/main/java");
        //需要修改
        gc.setAuthor("~瑞╭❤～");
        gc.setOpen(false);
...
//        pc.setModuleName(scanner("请输入你的包名"));
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return projectPath + "/"+moduleName +"/rikao7-client/src/main/resources/mappers/" /*+ pc.getModuleName()
