...
public class MybatisPlusConfig {
    ...
    public static void main(String[] args) {
     ...
     String moduleName = "wrd-springcloud-demo-0620";
        //   String moduleName = "";
        // 代码生成器
        ...
        gc.setOutputDir(projectPath + "/" +moduleName+"/hourse-service/src/main/java");
        //需要修改
        gc.setAuthor("~瑞╭❤～");
        gc.setOpen(false);
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/five-lx2?useUnicode=true&characterEncoding=utf8&serverTimezone=Asia/Shanghai");
...
//        pc.setModuleName(scanner("请输入你的包名"));
        //需要修改
        pc.setParent("com.wrd");//你哪个父目录下创建包
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return projectPath + "/"+moduleName +"/hourse-service/src/main/resources/mappers/" /*+ pc.getModuleName()
